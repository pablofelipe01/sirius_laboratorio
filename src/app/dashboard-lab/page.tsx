          ...
          <div className="container mx-auto px-4 py-8">
            <div className="max-w-4xl mx-auto text-center">
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <p className="text-gray-600 text-lg">Cargando Dashboard Lab...</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-gray-800">Filtros Estratégicos</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ej: 061125TR, 281025BV..."
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all placeholder-gray-400 text-gray-800 font-medium shadow-sm hover:border-gray-300"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-gray-800 font-medium shadow-sm hover:border-gray-300 bg-white"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-gray-800 font-medium shadow-sm hover:border-gray-300 bg-white"
                  >
                    <option value="" className="text-gray-500">🧬 Todos los microorganismos</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-gray-800 font-medium shadow-sm hover:border-gray-300"
                  />
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="px-6 py-4 bg-gradient-to-r from-blue-600 to-purple-600">
                <h2 className="text-xl font-semibold text-white">Registros de Inoculación</h2>
                <p className="text-blue-100 text-sm">Gestión completa de lotes de inoculación</p>
              </div>
              
              {loading ? (
                <div className="flex items-center justify-center py-12">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
                  <span className="ml-3 text-gray-600">Cargando registros de inoculación...</span>
                </div>
              ) : (
                <div className="overflow-x-auto shadow-sm rounded-lg border border-gray-200">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                      <tr>
                        ...
                        <th className="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider hidden md:table-cell">
                          🦠 Microorganismo
                        </th>
                        <th className="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">
                          📊 Estado
                        </th>
                        <th className="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider hidden lg:table-cell">
                          📅 Fecha Inoculación
                        </th>
                        <th className="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider hidden sm:table-cell">
                          📦 Cant. Inicial
                        </th>
                        <th className="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">
                          💼 Actual
                        </th>
                        <th className="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider hidden xl:table-cell">
                          👤 Responsable
                        </th>
                        <th className="px-4 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">
                          ⚡ Acciones
                        ...
                        <tr key={record.id} className="hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 transition-all duration-200">
                          <td className="px-4 py-4 whitespace-nowrap text-sm font-bold text-blue-600">
                            <div className="flex items-center">
                              <span className="font-mono">{record.fields['Codigo Lote'] || '-'}</span>
                            </div>
                          </td>
                          ...
                          <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-700 hidden sm:table-cell">
                            <span className="bg-gray-50 px-2 py-1 rounded-md border border-gray-200">
                              {record.fields['Cantidad Bolsas'] || 0} bolsas
                            </span>
                          </td>
                          <td className="px-4 py-4 whitespace-nowrap text-sm font-bold text-green-700">
                            <span className="bg-green-50 px-2 py-1 rounded-md border border-green-200">
                              {record.fields['Cantidad Actual Bolsas'] || 0} bolsas
                            </span>
                          </td>
                          ...
                          <td className="px-4 py-4 whitespace-nowrap text-sm">
                            <button
                              ...
                              className="inline-flex items-center px-3 py-2 text-xs font-bold text-white bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 transform hover:scale-105"
                            >
                              👁️ Ver
                            </button>
                          </td>
                  ...
                  {filteredRecords.length === 0 && (
                    <div className="text-center py-12">
                      <p className="text-gray-500 text-lg">No hay registros que coincidan con los filtros aplicados</p>
                    </div>
                  )}
                </div>
              )}
                  ...
                  <div className="p-8 space-y-8 max-h-[calc(95vh-120px)] overflow-y-auto">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-6 border border-blue-200 shadow-sm">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="bg-white p-5 rounded-xl shadow-sm border border-blue-200 hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-2">
                            <span className="text-2xl mr-2">📊</span>
                            <p className="font-bold text-gray-700 text-sm uppercase tracking-wide">Estado del Lote</p>
                          </div>
                          <p className="font-bold text-lg text-gray-900">{selectedLoteInfo.inoculacion.fields['Estado Lote'] || 'N/A'}</p>
                        </div>
                        <div className="bg-white p-5 rounded-xl shadow-sm border border-green-200 hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-2">
                            <span className="text-2xl mr-2">📅</span>
                            <p className="font-bold text-gray-700 text-sm uppercase tracking-wide">Fecha Inoculación</p>
                          </div>
                          <p className="font-bold text-lg text-gray-900">{selectedLoteInfo.inoculacion.fields['Fecha Inoculacion'] || 'N/A'}</p>
                        </div>
                        <div className="bg-white p-5 rounded-xl shadow-sm border border-purple-200 hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-2">
                            <span className="text-2xl mr-2">👤</span>
                            <p className="font-bold text-gray-700 text-sm uppercase tracking-wide">Responsable</p>
                          </div>
                          <p className="font-bold text-lg text-gray-900">{selectedLoteInfo.inoculacion.fields['Realiza Registro'] || 'N/A'}</p>
                        </div>
                        <div className="bg-white p-5 rounded-xl shadow-sm border border-yellow-200 hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-2">
                            <span className="text-2xl mr-2">🦠</span>
                            <p className="font-bold text-gray-700 text-sm uppercase tracking-wide">Microorganismo</p>
                          </div>
                          <p className="font-bold text-lg text-gray-900">{selectedLoteInfo.inoculacion.fields['Microorganismo (from Microorganismos)']?.[0] || 'N/A'}</p>
                        </div>
                        <div className="bg-white p-5 rounded-xl shadow-sm border border-red-200 hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-2">
                            <span className="text-2xl mr-2">📦</span>
                            <p className="font-bold text-gray-700 text-sm uppercase tracking-wide">Cantidad Inicial</p>
                          </div>
                          <p className="font-bold text-lg text-gray-900">{selectedLoteInfo.inoculacion.fields['Cantidad Bolsas'] || 0} bolsas</p>
                        </div>
                    ...
                    {selectedLoteInfo.salidas && selectedLoteInfo.salidas.length > 0 && (
                      <div className="bg-gradient-to-r from-slate-50 via-gray-50 to-slate-50 rounded-2xl p-6 border border-slate-200 shadow-sm">
                        <h3 className="text-xl font-bold text-slate-900 mb-6 flex items-center">
                          <div className="bg-gradient-to-r from-slate-600 to-gray-700 rounded-full p-2 mr-3">
                            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                            </svg>
                          </div>
                          📋 Detalle de Todas las Salidas ({selectedLoteInfo.salidas.length} registros)
                        </h3>
                        <div className="overflow-x-auto shadow-sm rounded-lg border border-slate-200">
                          <table className="min-w-full bg-white rounded-lg">
                            <thead className="bg-gradient-to-r from-slate-100 to-gray-100">
                              <tr>
                                <th className="px-6 py-4 text-left text-xs font-bold text-slate-800 uppercase tracking-wider">📅 Fecha</th>
                                <th className="px-6 py-4 text-left text-xs font-bold text-slate-800 uppercase tracking-wider">📦 Cantidad</th>
                                <th className="px-6 py-4 text-left text-xs font-bold text-slate-800 uppercase tracking-wider">🎯 Propósito</th>
                                <th className="px-6 py-4 text-left text-xs font-bold text-slate-800 uppercase tracking-wider">👤 Responsable</th>
                              </tr>
                            </thead>
